...
<body>
    <div class=" container">
        ...
        <div class="card mt-3 mx-auto border border-0" style="width: 30rem">
            ...
            <form action="ubah_password.php" method="post">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary py-2 mt-3 w-50">Submit
                    </button>
                    <button type="reset" class="btn btn-danger py-2 mt-3 w-50">reset</button>
                </div>
            </form>
