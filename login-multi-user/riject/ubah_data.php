<?php
include "../koneksi.php";
$sql = mysqli_query($conn, "select* from reject where id_reject='$_GET[kode]'");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../tracking_unit/inpu_data.php">Tracking Unit</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="input_riject.php.php">Input riject</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../laporan_harian_mesin/input.php">Input Laporan Harian Mesin</a></li>
                        ...
                        <form action="" method="post">
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <select class="form-select" name="shift" value="<?php echo $data['shift']; ?>" id=" shift">
                                    ...
                                    <div class="col mb-1">
                                        ...
                                        <input type="text" class="form-control" name="mesin2" value="<?php echo $data['mesin2']; ?>" id=" mesin2">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col">
                                        <label for="avalatas" class="form-label">Aval Atas</label>
                                        <input type="number" class="form-control" name="avalatas" value="<?php echo $data['avalatas']; ?>" id="avalatas">
                                    </div>
                                    <div class="col">
                                        <label for="avalbawah" class="form-label">Aval Bawah</label>
                                        <input type="number" class="form-control" name="avalbawah" value="<?php echo $data['avalbawah']; ?>" id="avalbawah">
                                    </div>
                                    <div class="col mb-1">
                                        <label for="avaldalam" class="form-label">Aval dalam</label>
                                        <input type="number" class="form-control" name="avaldalam" value="<?php echo $data['avaldalam']; ?>" id="avaldalam">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" name="watermark" value="<?php echo $data['watermark']; ?>" id="watermark">
                                </div>

                                <div class="col">
                                    <label for="Laminasi" class="form-label">Laminasi</label>
                                    <input type="text" class="form-control" name="laminasi" value="<?php echo $data['laminasi']; ?>" id="laminasi">
                                </div>

                                <div class="col mb-1">
                                    <label for="nabrakknife" class="form-label">Nabrak Knife</label>
                                    <input type="int" class="form-control" name="nabrakknife" value="<?php echo $data['nabrakknife']; ?>" id="nabrakknife">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="cuilsisi" class="form-label">Cuil Sisi</label>
                                    <input type="number" class="form-control" name="cuilsisi" value="<?php echo $data['cuilsisi']; ?>" id="cuilsisi">
                                </div>
                                <div class="col-md-6">
                                    <label for="lainnya" class="form-label">Lainnya</label>
                                    <input type="number" class="form-control" name="lainnya" value="<?php echo $data['lainnya']; ?>" id="lainnya">
                                </div>
                            </div>
                            <tr>
...
<!-- ubah data reject-->
                ...
                if (isset($_POST['simpan'])) {
                    mysqli_query($conn, "update reject set
                                ...
                                where id_reject = $_GET[kode]
                                ");
                    echo "Reject  telah di Update";
                    echo "<meta http-equiv=refresh content=1;URL='data_riject.php'>";
                }
                ?>
                        <!-- close ubah data -->
